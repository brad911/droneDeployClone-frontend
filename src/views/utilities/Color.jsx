            ...
            <Grid container spacing={gridSpacing}>
              ...
              <Grid size={{ xs: 12, sm: 6, md: 4, lg: 2 }}>
                <ColorBox
                  ...
                  data={{ label: 'Grey-500', color: theme.palette.secondary.main }}
              ...
              <Grid size={{ xs: 12, sm: 6, md: 4, lg: 2 }}>
                <ColorBox
                  ...
                  data={{ label: 'Deep grey-600', color: theme.palette.secondary.dark }}
              ...
              <Grid size={{ xs: 12, sm: 6, md: 4, lg: 2 }}>
                <ColorBox
                  ...
                  data={{ label: 'Black-800', color: theme.palette.secondary[800] }}
                  title="secondary[800]"
                />
              </Grid>
            </Grid>
